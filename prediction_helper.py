...
model_young = pickle.load(open("model_young.sav", 'rb'))
model_rest = pickle.load(open("model_rest.sav", 'rb'))
scaler_young = pickle.load(open("scaler_young.sav", 'rb'))
scaler_rest = pickle.load(open("scaler_rest.sav", 'rb'))
